...
DIFFICULTY_LEVELS = {
    ...
    "Medium": {"min_value": 10, "max_value": 100, "color": "#FFDE59"},
    "Hard": {"min_value": 100, "max_value": 1000, "color": "#5CE1E6"}
}
...
class MathGameGUI:
    ...
    def display_question(self):
        ...
        self.next_button.grid(row=3, column=0, columnspan=2, padx=10, pady=5)
    ...
    def end_game(self):
        ...
        self.retry_button.grid(row=1, column=0, padx=10, pady=5)
        self.home_button = tk.Button(self.root, text="Home", command=self.go_to_home, font=("Helvetica", 16))
        self.home_button.grid(row=1, column=1, padx=10, pady=5)
