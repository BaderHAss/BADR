...
class MathGame:
    ...
    def initialize_game(self):
        ...
        self.level.set("")
        easy_radio.configure(state="normal")
        medium_radio.configure(state="normal")
        hard_radio.configure(state="normal")
    ...
    def start_game(self):
        ...
        easy_radio.configure(state="disabled")
        medium_radio.configure(state="disabled")
        hard_radio.configure(state="disabled")
